...
public abstract class AbstractPathAnimator {
    ...
    public static class Config {
        ...
        static Config fromTypeArray(TypedArray typedArray) {
            ...
            config.initX = (int) typedArray.getDimension(R.styleable.lamp_HeartLayout_lamp_initX,
                    res.getDimensionPixelOffset(R.dimen.heart_anim_init_x));
            config.initY = (int) typedArray.getDimension(R.styleable.lamp_HeartLayout_lamp_initY,
                    res.getDimensionPixelOffset(R.dimen.heart_anim_init_y));
            config.xRand = (int) typedArray.getDimension(R.styleable.lamp_HeartLayout_lamp_xRand,
                    res.getDimensionPixelOffset(R.dimen.heart_anim_bezier_x_rand));
            config.animLength = (int) typedArray.getDimension(R.styleable.lamp_HeartLayout_lamp_animLength,
                    res.getDimensionPixelOffset(R.dimen.heart_anim_length));
            config.animLengthRand = (int) typedArray.getDimension(R.styleable.lamp_HeartLayout_lamp_animLengthRand,
            ...
            config.xPointFactor = (int) typedArray.getDimension(R.styleable.lamp_HeartLayout_lamp_xPointFactor,
                    res.getDimensionPixelOffset(R.dimen.heart_anim_x_point_factor));
            config.heartWidth = (int) typedArray.getDimension(R.styleable.lamp_HeartLayout_lamp_heart_width,
                    res.getDimensionPixelOffset(R.dimen.heart_size_width));
            config.heartHeight = (int) typedArray.getDimension(R.styleable.lamp_HeartLayout_lamp_heart_height,
